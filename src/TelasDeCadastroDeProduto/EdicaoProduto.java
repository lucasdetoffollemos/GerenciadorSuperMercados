...
import TelasDeCadastroDeProduto.VizualizaExcluiEditaProduto;
...
public class EdicaoProduto extends javax.swing.JFrame {
    ...
    public EdicaoProduto(Produto p) {
        ...
        setaValoresDoProduto();  
    }
    
     private void setaValoresDoProduto() {
        String precoStr, descricao;
        precoStr = String.valueOf(produto.getPreco());
    ...
    private void voltaParaTelaAnterior() {
        VizualizaExcluiEditaProduto crudProduto = new VizualizaExcluiEditaProduto();
    ...
    private void jButtonVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVoltarActionPerformed
        //Nesta tela quando volta, é criada um novo JFrame para a tela anterior, pois ela foi tirada, por conta de quando voltar desta é necessario atualizar alguns valores
        voltaParaTelaAnterior();
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        if(!descricao.equals("") && !precoStr.equals("")){
            editarProduto(descricao,precoStr);   
        }
        else{
