...
public class CadastroProdutos extends javax.swing.JFrame {
    ...
    private boolean verificaSeCodigoExiste(int cod) {
    ...
    private void insereProduto(String codStr, String descricao, String precoStr) {
        ...
        boolean jaExisteCodigo = verificaSeCodigoExiste(cod);
  
        if(jaExisteCodigo == false){
    ...
    private void jButtonInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInserirActionPerformed
        ...
        if(!codStr.equals("") && !descricao.equals("") && !precoStr.equals("")){
            insereProduto(codStr, descricao, precoStr);
